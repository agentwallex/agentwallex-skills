...
2. **Check the agent's balance.** Run `npx @agentwallex/cli@0.1.0 balance <agent-id>` to ensure sufficient funds.
...
| Command                                                       | Description                          |
|---------------------------------------------------------------|--------------------------------------|
| `npx @agentwallex/cli@0.1.0 status`                          | Verify connection                    |
| `npx @agentwallex/cli@0.1.0 balance <agent-id>`              | Check balance before paying          |
